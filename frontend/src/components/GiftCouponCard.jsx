...
const GiftCouponCard = () => {
	...
	return (
		<motion.div
			className="space-y-4 rounded-lg border border-gray-300 bg-white p-4 shadow-sm sm:p-6"
		...
		>
			<div className="space-y-4">
				<div>
					...
					<input
						...
						p-2.5 text-sm text-gray-800 placeholder-gray-500 focus:border-emerald-500 
			...
			{coupon && !isCouponApplied && (
				<div className="mt-4">
					<h3 className="text-lg font-medium text-gray-800">Your Available Coupon:</h3>
					<p className="mt-2 text-sm text-gray-600">
						{coupon.code} - {coupon.discountPercentage}% off
					</p>
				</div>
