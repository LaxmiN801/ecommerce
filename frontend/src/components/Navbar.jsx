			...
			<div className='container mx-auto px-4 py-3'>
				<div className='flex flex-wrap justify-between items-center'>
					...
					<nav className='flex flex-wrap items-center gap-4'>
						...
						{user && (
							...
							>
								...
								<span
									...
									text-xs group-hover:bg-gray-200 transition duration-300 ease-in-out'
								>
									{cart.length}
								</span>
								)}
						...
						{isAdmin && (
							<Link
								className='bg-white text-black hover:bg-gray-200 px-3 py-1 rounded-md font-medium
						...
						onClick={logout}
							...
							<>
								<Link
									to={"/signup"}
									className='bg-white text-black hover:bg-gray-100 py-2 px-4 
									rounded-md flex items-center transition duration-300 ease-in-out'
								>
									<UserPlus className='mr-0.5' size={18} />
								...
								<Link
									...
									rounded-md flex items-center transition duration-300 ease-in-out'
								>
									<LogIn className='mr-0.5' size={18} />
